...
Her er `/path/to/script.js` en absolut sti til scriptet fra sitets rod. Du kan også give en relativ sti fra det aktuelle HTML-dokument. F.eks. betyder `src="script.js"` (eller `src="./script.js"`) at filen `"script.js"` findes i samme folder som HTML-dokumetet.
